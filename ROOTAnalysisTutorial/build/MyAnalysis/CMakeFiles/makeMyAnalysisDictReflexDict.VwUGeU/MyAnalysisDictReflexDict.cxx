...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::MyxAODAnalysis*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("MyxAODAnalysis", "MyxAODAnalysis.h", 11,
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("libMyAnalysisDict",
        ...
        TriggerDictionaryInitialization_libMyAnalysisDict_Impl, {{"namespace DataVector_detail { template <typename T> class DVLEltBaseInit; }", 1},{"namespace DataVector_detail { template <typename B1, typename B2, typename B3> class VirtBases; }", 1},{"template <typename T> class DataVectorBase;", 1},{"template <typename T, typename BASE> class DataVector;", 1}}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
